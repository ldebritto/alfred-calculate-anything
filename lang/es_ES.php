...
return [
    ...
    'config' => [
        ...
        'exchangerateapi_title' => 'Definir la API de ExchangeRate-API',
        'exchangerateapi_subtitle' => 'Ingresa la API Key de ExchangeRate-API',
    ...
    'currency' => [
        ...
        'noapikey_title' => 'Debes de configurar la API key de ExchangeRate-API',
    ],
    'crypto_currency' => [
        'cmd' => 'Presiona enter para copiar el valor al clipboard sin formato',
        'alt' => 'Presiona enter para copiar el valor de 1 al clipboard',
