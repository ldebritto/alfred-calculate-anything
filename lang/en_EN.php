...
return [
    ...
    'config' => [
        ...
        'exchangerateapi_title' => 'Set ExchangeRate-API Key',
        'exchangerateapi_subtitle' => 'Configure your ExchangeRate-API Key',
    ...
    'currency' => [
        ...
        'noapikey_title' => 'You need to configure the API key for ExchangeRate-API',
    ],
    'crypto_currency' => [
        'cmd' => 'Action this item to copy the amount with no format',
        'alt' => 'Action this item to copy the value of 1 to the clipboard',
